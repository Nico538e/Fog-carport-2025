...
public class ItemMapper {
    ...
    public static Item getOneItemById(ConnectionPool connectionPool, int toppingId) throws DatabaseException {
        ...
        try (Connection connection = connectionPool.getConnection();
            ...
            if (rs.next()) {
                ...
                return new Item(itemId, itemName, itemHeight, itemWidth, itemTypeId, itemPackageType, itemCostPrice);
            }
